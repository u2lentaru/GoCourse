...
func TestQuadraticEquation(t *testing.T) {
	...
	if real(v1) != 1 && imag(v1) != 1 && real(v2) != 2 && imag(v2) != 2 {
		t.Error("Expected 1+i,2+2i got", v1, v2)
	}
}
...
//c:\Golang_work\src\GoCourse\homework-6\qe\qe_test.go:9: Expected 1+i,2+2i got (-1+1.4142135623730951i) (-1-1.4142135623730951i)
//FAIL
